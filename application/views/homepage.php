        ...
        <div class="item active" data-interval="100">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <a class="btn btn-lg btn-danger" href="/PizzaNow/index.php/HomePage/menu" role="button">ORDER ONLINE
                        NOW</a>
                </div>
            </div>
        </div>
        <div class="item" data-interval="100">
            <img class="second-slide" src="<?php echo base_url('public/images/slide2.jpg') ?>" height="30%"
                 alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <p>Cheesy blast</p>
                    <h1>Super cheesy Pizzas</h1>
                    <a class="btn btn-lg" href="/PizzaNow/index.php/HomePage/menu" role="button">ORDER ONLINE NOW</a>
                </div>
            </div>
        </div>
        <div class="item" data-interval="100">
...
<div id="about" class="container">
    <div class="jumbotron home-about ">
        ...
        <div class="col-md-7">
            <img class="img-responsive img-icon " src="<?php echo base_url('public/images/icon_new.png') ?>"
                 alt="pizza icon">
            <h2>Welcome to PizzaNow!</h2>
            <p class="text-danger font-italic">Our chefs are working 24/7 and are ready to accept visitors and at any
                time of the day and night.</p> <br>
            <p class="text-warning">We would like to take this opportunity to welcome you at our Pizza House. We are
                offering a warm, friendly atmosphere to share a meal with family and friends at any time of the day or
                evening.</p>
        ...
        <div class="col-md-5">
            <img class="img-fluid img-responsive" src="<?php echo base_url('public/images/pizzanow.png') ?>"
                 alt="pizza icon">
        </div>
    </div>
</div>
...
<div class="jumbotron home-menu">
    ...
    <div class="container home-menu-items">
        <div class="row">
            <div class="col-sm-4">
                <img class="img-fluid img-responsive align-content-center"
                     src="<?php echo base_url('public/images/product_1.png') ?>" alt="pizza icon">
                <h3>Margherita Pizza</h3>
            </div>
            <div class="col-sm-4">
                <img class="img-fluid img-responsive align-content-center"
                     src="<?php echo base_url('public/images/product_2.png') ?>" alt="pizza icon">
                <h3>Pepperoni Pizza</h3>
            </div>
            <div class="col-sm-4">
                <img class="img-fluid img-responsive align-content-center"
                     src="<?php echo base_url('public/images/product_3.png') ?>" alt="pizza icon">
                <h3>Mexican Pizza</h3>
            </div>
        </div>
        <div class="text-center">
            <a href="/PizzaNow/index.php/HomePage/menu" type="button" class="btn btn-menu">View more</a>
        </div>
            ...
            <div class="card-body card-body-cascade text-center">
                ...
                <div class="mapouter">
                    <div class="gmap_canvas">
                        <iframe width="390" height="500" id="gmap_canvas"
                                src="https://maps.google.com/maps?q=ragama%20road&t=&z=13&ie=UTF8&iwloc=&output=embed"
