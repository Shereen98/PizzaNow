...
<div class="container">
    ...
    <div class="row">
                        ...
                        <div class="btn sizeButtonGroup btn-group-justified" data-toggle="buttons">
                            <?php if (!empty($pizza)) { ?>
                                <label class="btn btn-default pizzaSize active">
                                    ...
                                    <input type="radio" name="size" value="<?php echo $pizza["regular_pizza_price"]; ?>"
                                           checked>
                                </label>
                ...
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                        <div id="vegTopping" class="tab-pane fade in active">
                            <div class="row">
                                <?php if (!empty($vegTopping)) {
                                    foreach ($vegTopping as $row) { ?>
                                        <div class="col-sm-6">
                                            <div class="btn" data-toggle="buttons">
                                                <label class="btn btn-default">
                                                    <input type="checkbox" class="topping"
                                                           id="<?php echo $row["topping_id"]; ?>" autocomplete="off"
                                                           name="topping" value="<?php echo $row["price"]; ?>">
                                                    <div class="media">
                                                        <div class="media-left media-middle">
                                                            <img class="media-object" style="width:60px"
                                                                 src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['topping_image']); ?>"/>
                                                        </div>
                        ...
                        <div id="nonVegTopping" class="tab-pane fade">
                            <div class="row">
                                <?php if (!empty($nonVegTopping)) {
                                    foreach ($nonVegTopping as $row) { ?>
                                        <div class="col-sm-6">
                                            <div class="btn" data-toggle="buttons">
                                                <label class="btn btn-default">
                                                    <input type="checkbox" class="topping" name="topping"
                                                           id="<?php echo $row["topping_id"]; ?>"
                                                           value="<?php echo $row["price"]; ?>" autocomplete="off">
                                                    <div class="media">
                                                        <div class="media-left media-middle">
                                                            <img class="media-object" style="width:60px"
                                                                 src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['topping_image']); ?>"/>
        ...
        <div class="col-md-5 col-md-pull-7">
            <div class="text-left">
                <a type="button" href='/PizzaNow/index.php/HomePage/menu' class="btn btn-warning"><span
            ...
            <?php if (!empty($pizza)) { ?>
                <div class="thumbnail" id="model-thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <h2 class="text-center">Rs.<input id="total_price" type="number" name="text"
                                                          value="<?php echo $pizza["regular_pizza_price"]; ?>"
                                                          readonly="true"></h2>
                        <br>
                        <div class="text-center">
                            <button class="btn btn-danger decrement" type="button"><span
                            ...
                            <button class="btn btn-success increment" type="button"><span
                                        class='glyphicon glyphicon-plus'></span></button>
                            &nbsp;
                            <button class="btn menu-btn" onclick="addtocart(<?php echo $pizza['pizza_id'] ?>)"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer text-center">
                <a type="button" style="background-color: maroon;color: white" class="btn btn-default"
