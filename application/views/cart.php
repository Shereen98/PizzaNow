        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <?php
                    ...
                    echo "<li class='nav-item cta cta-colored active'><a href='/PizzaNow/Cart/' class='nav-link'><span class='glyphicon glyphicon-shopping-cart'></span>&nbsp; Cart</a></li>";
                ?>
            </ul>
        </div>
    </div>
    ...
    <div class="well">
        <div class="row">
            ...
            <div class="col-sm-8">
                            ...
                            <?php if(!empty($pizza) || !empty($side) || !empty($meal)) { ?>
                                <table class="table table-hover cart-table">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn update-btn" style="color: black" href="<?php echo base_url('Cart/updatePizzaCart/'. $item['id'].'/decrement');?>" ><span class='glyphicon glyphicon-minus'></span></a>
                                            <input  id="<?php echo 'product_qty'.$item["id"]; ?>" type="number" name="text" value="<?php echo $item['quantity'];?>" readonly="true">
                                            <a class="btn update-btn" style="color: black" type="button" href="<?php echo base_url('Cart/updatePizzaCart/'. $item['id'].'/increment');?>" ><span class='glyphicon glyphicon-plus'></span></a>
                                        </td>
                                   ...
                                   <?php if(!empty($side)) { foreach ($side as $item) { ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?php echo $item['price']; ?></td>
                                        <td>
                                            <a class="btn update-btn" style="color: black" href="<?php echo base_url('Cart/updateSideCart/'. $item['id'].'/decrement');?>" ><span class='glyphicon glyphicon-minus'></span></a>
                                            <input  id="<?php echo 'product_qty'.$item["id"]; ?>" type="number" name="text" value="<?php echo $item['quantity'];?>" readonly="true">
                                            <a class="btn update-btn" style="color: black" type="button" href="<?php echo base_url('Cart/updateSideCart/'. $item['id'].'/increment');?>"><span class='glyphicon glyphicon-plus'></span></a>
                                        </td>
                                   ...
                                   <?php }} ?>
                                    ...
                                    <?php if(!empty($meal)) { foreach ($meal as $item) { ?>
                                        <tr class="text-center">
                                            ...
                                            <td><?php echo $item['price']; ?></td>
                                            <td>
                                                <a class="btn update-btn" style="color: black" href="<?php echo base_url('Cart/updateMealCart/'. $item['id'].'/decrement');?>" ><span class='glyphicon glyphicon-minus'></span></a>
                                                <input  id="<?php echo 'product_qty'.$item["id"]; ?>" type="number" name="text" value="<?php echo $item['quantity'];?>" readonly="true">
                                                <a class="btn update-btn" style="color: black" type="button" href="<?php echo base_url('Cart/updateMealCart/'. $item['id'].'/increment');?>" ><span class='glyphicon glyphicon-plus'></span></a>
                                            </td>
                                            <td id="meal_price"><?php echo $item['quantity']*$item['price'].'.00'; ?></td>
                                            <td>
                                                <a href="<?php echo base_url('Cart/removeMeal/'. $item['id']);?>" class="btn btn-warning">
                                                    <span class="glyphicon glyphicon-trash"></span>
                                                </a>
                                            </td>
                                        </tr>
                ...
                <a type="button" href='/PizzaNow/HomePage/menu' style="background-color: green;font-weight: bold!important;color: white;border-radius: 10px!important;" class="btn "><span class="glyphicon glyphicon-arrow-left"></span> &nbsp; Continue Shopping</a>
            </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="text-right">
                    <a type="button" href="<?php echo base_url('Cart/checkout/');?>" class="btn" style="background-color: darkred;font-weight: bold!important;color: white;border-radius: 10px!important;"> Checkout &nbsp;<span class="glyphicon glyphicon-arrow-right"></span> </a>
                </div>
            </div>
